...
impl AdvancedPaymentInfo {
    pub fn new(contract_id: String, locked_amount: String, minimum_amount: String, buyer: String, seller: String, provider: String, expires_at: String) -> AdvancedPaymentInfo {
        AdvancedPaymentInfo {
            contract_id,
            locked_amount,
            minimum_amount,
