...
impl ParticipantPermission {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ParticipantPermission::Unspecified => "PARTICIPANT_PERMISSION_UNSPECIFIED",
            ParticipantPermission::Submission => "PARTICIPANT_PERMISSION_SUBMISSION",
            ParticipantPermission::Confirmation => "PARTICIPANT_PERMISSION_CONFIRMATION",
            ParticipantPermission::Observation => "PARTICIPANT_PERMISSION_OBSERVATION",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PackageStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PackageStatus::Unspecified => "PACKAGE_STATUS_UNSPECIFIED",
            PackageStatus::Registered => "PACKAGE_STATUS_REGISTERED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
