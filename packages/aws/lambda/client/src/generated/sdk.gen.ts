 ...
 * Signs a message using the Ed25519 keypair for the given login identifier
 */
export const signMessage = <ThrowOnError extends boolean = false>(options: Options<SignMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SignMessageResponses, SignMessageErrors, ThrowOnError>({
        url: '/sign-message',
        ...options,
        headers: {
            'Content-Type': 'application/json',
