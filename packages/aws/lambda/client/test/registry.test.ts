...
describe('Registry Management', () => {
  ...
  describe('Developer Management', () => {
    it('should add a developer to the registry', async () => {
      if (!testRegistryId) {
        console.log('Skipping: No registry ID available. Run createRegistry test first.');
        return;
      }
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      assert.strictEqual(typeof response.tx_digest, 'string', 'Transaction digest should be a string');
      console.log(`Developer '${testDeveloperName}' added with tx: ${response.tx_digest}`);
    });
    ...
    it('should update a developer in the registry', async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`Developer '${testDeveloperName}' updated with tx: ${response.tx_digest}`);
    });
  });
  ...
  describe('Agent Management', () => {
    it('should add an agent to the registry', async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`Agent '${testAgentName}' added with tx: ${response.tx_digest}`);
    });
    ...
    it('should update an agent in the registry', async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`Agent '${testAgentName}' updated with tx: ${response.tx_digest}`);
    });
    ...
    it('should remove an agent from the registry', { skip: true }, async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`Agent '${testAgentName}' removed with tx: ${response.tx_digest}`);
    });
  });
  ...
  describe('App Management', () => {
    ...
    it('should update an app in the registry', async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`App '${testAppName}' updated with tx: ${response.tx_digest}`);
    });
    ...
    it('should remove an app from the registry', { skip: true }, async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`App '${testAppName}' removed with tx: ${response.tx_digest}`);
    });
  });
  ...
  describe('Developer Removal', () => {
    it('should remove a developer and its agents', { skip: true }, async () => {
      ...
      assert.ok(response.tx_digest, 'Response should contain a tx_digest');
      console.log(`Developer '${testDeveloperName}' removed with tx: ${response.tx_digest}`);
    });
  });
