/// DigiCert Global Root G2 certificate in PEM format
/// This is the root certificate used to verify Binance's TLS certificate chain
/// Valid from: Aug 1, 2013 to Jan 15, 2038
pub const DIGICERT_GLOBAL_ROOT_G2_PEM: &str = r#"-----BEGIN CERTIFICATE-----
...
/// DigiCert Global Root G2 certificate in DER format (binary)
/// This can be used directly in zkVM environments where PEM parsing might not be available
pub const DIGICERT_GLOBAL_ROOT_G2_DER: &[u8] = &[
    ...
    0x26, 0x95, 0x5d, 0xbe, 0xdd, 0x0d, 0xc6, 0x37, 0x7d, 0xed, 0x03, 0x92, 0x1b, 0xe5, 0x77, 0x5f,
    0x76, 0xee, 0x3c, 0x8d, 0xc4, 0x5d, 0x56, 0x5b, 0xa2, 0xd9, 0x66, 0x6e, 0xb3, 0x35, 0x37, 0xe5,
    0x32, 0xb6
];

/// DigiCert Assured ID Root CA certificate in PEM format
/// This is the root certificate used to verify TSA timestamp certificates
/// Valid from: Nov 10, 2006 to Nov 10, 2031
pub const DIGICERT_ROOT_G4_PEM: &str = r#"-----BEGIN CERTIFICATE-----
